...
static const int dst_width = 1280;
static const int dst_height = 720;
static const int dst_vbit_rate = 748000;
...
{
	clock_t start_point, end_point;	//time 변수 선언
	start_point = clock();	//time start
